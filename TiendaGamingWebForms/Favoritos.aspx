<%@ Page Title="" Language="C#" MasterPageFile="~/Gaming.Master" AutoEventWireup="true" CodeBehind="Favoritos.aspx.cs" Inherits="TiendaGamingWebForms.Favoritos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 class="text-3xl font-bold mb-6 dark:text-white">Mis Favoritos</h2>
    ...
    <asp:Label ID="lblMensajeVacio" runat="server" Text="Aún no has agregado productos a tu lista de deseos." 
               CssClass="text-center text-white/70 text-lg" Visible="false" />
